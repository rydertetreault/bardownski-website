...
const seasons: SeasonSummary[] = [
  ...
  },
  {
    ...
    captain: "Ryder",
    summary:
      "A breakout year. Ryder became the first goaltender named captain in club history. The roster solidified and the team started climbing the ranks.",
  },
  {
    year: "2025",
    rosterSize: 10,
  ...
  return (
    <section ref={ref} className="bg-[#1a2744] w-full">
      ...
      <div className="flex flex-col md:flex-row min-h-[500px]">
        ...
        >
          <Image
            src="/images/gallery/screenshots/t.png"
            alt="Bardownski Hockey Club — players celebrating"
            fill
