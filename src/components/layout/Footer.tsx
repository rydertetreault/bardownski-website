...
export default function Footer() {
  return (
    <footer className="bg-navy-dark border-t border-border">
      <div className="hockey-page-container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wider mb-4 text-gold">Team</h4>
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wider mb-4 text-gold">Community</h4>
            <ul className="space-y-2 text-sm text-muted">
              ...
              <li><Link href="/fc" className="hover:text-white transition-colors">Bardownski FC</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wider mb-4 text-gold">Connect</h4>
            <div className="flex gap-4">
              <a href="https://discord.gg/QunuzvaC" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-gold transition-colors" aria-label="Discord">
