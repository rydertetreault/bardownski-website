...
export default async function NewsPage() {
  ...
  return <div className="news-edition">
    <header className="news-masthead"><div><p className="news-eyebrow">THE LEGACY EDITION · NEWS</p><h1>THE CLUB <em>JOURNAL.</em></h1></div><div className="news-masthead-note"><span>NEWFOUNDLAND ROOTS.</span><p>The big nights. The quiet work.<br />The stories behind the sweater.</p><small>{items.length} STORIES IN THE JOURNAL</small></div></header>
